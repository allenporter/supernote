...
class RandomCodeResponse(BaseResponse):
    random_code: str | None = field(metadata=field_options(alias="randomCode"), default=None)
...
class LoginResponse(BaseResponse):
    token: str | None = None
    user_name: str | None = field(metadata=field_options(alias="userName"), default=None)
    is_bind: str = field(metadata=field_options(alias="isBind"), default="N")
    is_bind_equipment: str = field(metadata=field_options(alias="isBindEquipment"), default="N")
...
class UserVO(DataClassJSONMixin):
    ...
    email: str | None = None
    phone: str | None = None
    country_code: str | None = field(metadata=field_options(alias="countryCode"), default=None)
    total_capacity: str = field(metadata=field_options(alias="totalCapacity"), default="0")
    file_server: str = field(metadata=field_options(alias="fileServer"), default="0")
    avatars_url: str | None = field(metadata=field_options(alias="avatarsUrl"), default=None)
